...
export default function Byline() {
  return (
    <div className="fixed right-4 top-4 z-50 flex flex-col items-end gap-1 text-right sm:right-6 sm:top-5">
      ...
      <a
        ...
        className="group inline-flex items-center gap-1.5 text-[13px] font-medium text-zinc-400 transition-colors hover:text-sky-300"
      >
